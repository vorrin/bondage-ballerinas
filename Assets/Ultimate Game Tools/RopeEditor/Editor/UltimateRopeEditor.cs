...
//      PropAutoRegenerate               = serializedObject.FindProperty("AutoRegenerate");
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            PropEventsObjectReceiver.objectReferenceValue = EditorGUILayout.ObjectField(new GUIContent("Events Object Receiver", "GameObject whose methods will be called when events are triggered"), PropEventsObjectReceiver.objectReferenceValue, typeof(GameObject), true);
            PropOnBreakMethodName.stringValue = EditorGUILayout.TextField(new GUIContent("Break Event Method", "Name of the method that will be called when a rope link breaks"), PropOnBreakMethodName.stringValue);
        }
